...
BasicGame.MainMenu.prototype = {
	...
	create: function () {
		...
		//Outputting sky, ship, score, lives, total and Start Time to the screen//The scrolling starfield background
		starfield = this.add.titleSprite(0, 0, 800, 600, 'starfield');
		logo = this.add.sprite((this.world.width / 2), (this.world.height / 2) + 50, 'startButton', this.startGame);
